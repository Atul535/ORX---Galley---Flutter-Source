...
class LightsMasterLavToekickPanel extends StatelessWidget {
  const LightsMasterLavToekickPanel({super.key});

  static const String _menuKey = 'lights_master_lav_toekick';
  static const String _prefix = 'master_lav_toekick';
