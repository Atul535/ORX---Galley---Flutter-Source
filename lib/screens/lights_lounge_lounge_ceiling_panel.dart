...
class LightsLoungeLoungeCeilingPanel extends StatelessWidget {
  const LightsLoungeLoungeCeilingPanel({super.key});

  static const String _menuKey = 'lights_lounge_ceiling';
  static const String _prefix = 'lounge_ceiling_';
