...
class EntertainmentLoungeFwd extends StatefulWidget {
  const EntertainmentLoungeFwd({super.key, title});

  @override
  State<EntertainmentLoungeFwd> createState() => _EntertainmentLoungeFwdState();
}

class _EntertainmentLoungeFwdState extends State<EntertainmentLoungeFwd> with TickerProviderStateMixin {
  String title = '';
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'lounge_Camera5Fwd',
      'lounge_Camera6Fwd',
      'lounge_HDMILoungeFwd',
      'lounge_HDMIGlobalFwd',
      'lounge_HDMIAVODFwd',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'lounge_MapFwd') {
      return 'MAP CONTROLS';
    }
  ...
  @override
  void didUpdateWidget(EntertainmentLoungeFwd oldWidget) {
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['lounge_video_fwd'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['lounge_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwr = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MonitorPwrFwd') as GenericSelection;
    ...
    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MapFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMILounge = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMILoungeFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMIGlobalFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMIAVODFwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera1Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera2Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera3Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera4Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera5Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera6Fwd') as GenericSelection;
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'lounge_Camera6Fwd') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['lounge_video_fwd'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'lounge_brightnessFwd', // ⭐ ID z config
    ) as BargraphModel;
