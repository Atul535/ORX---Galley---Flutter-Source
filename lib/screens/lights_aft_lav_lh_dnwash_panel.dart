...
class LightsAftLavLhDnwashPanel extends StatelessWidget {
  const LightsAftLavLhDnwashPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_lh_dnwash';
  static const String _prefix = 'aft_lav_lh_dnwash';
