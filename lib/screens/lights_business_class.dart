...
class LightsBusinessClassScreen extends StatefulWidget {
  const LightsBusinessClassScreen({super.key, title});

  @override
  State<LightsBusinessClassScreen> createState() => _LightsBusinessClassScreenState();
}

class _LightsBusinessClassScreenState extends State<LightsBusinessClassScreen> with TickerProviderStateMixin {
  String title = '';
        ...
        child: Stack(
          children: [
            Align(
              ...
              child: SafeArea(
                child: LightsBusinessClassMainScreen(),
              ),
            ),
          ],
        ),
