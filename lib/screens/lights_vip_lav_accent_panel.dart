...
class LightsVipLavAccentPanel extends StatelessWidget {
  const LightsVipLavAccentPanel({super.key});

  static const String _menuKey = 'lights_vip_lav_accent';
  static const String _prefix = 'vip_lav_accent';
