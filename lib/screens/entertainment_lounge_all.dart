...
class EntertainmentLoungeAll extends StatefulWidget {
  const EntertainmentLoungeAll({super.key, title});

  @override
  State<EntertainmentLoungeAll> createState() => _EntertainmentLoungeAllState();
}

class _EntertainmentLoungeAllState extends State<EntertainmentLoungeAll> with TickerProviderStateMixin {
  String title = '';
  ...
  bool get hasControls {
    ...
    // return selectedSource == 'globalEntertainmentMap' || selectedSource!.contains('Camera6');
  }
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'lounge_Camera5All',
      'lounge_Camera6All',
      'lounge_HDMILoungeAll',
      'lounge_HDMIGlobalAll',
      'lounge_HDMIAVODAll',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'lounge_MapAll') {
      return 'MAP CONTROLS';
    }
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['lounge_video_all'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['lounge_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwrOff = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MonitorPwrOffAll') as GenericSelection;
    GenericSelection globalEntertainmentMonitorPwrOn = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MonitorPwrOnAll') as GenericSelection;
    GenericSelection globalEntertainmentSpeakerPwrOff = menuItemsAudio.firstWhere((element) => element.id == 'lounge_SpeakerPwrOff') as GenericSelection;
    GenericSelection globalEntertainmentSpeakerPwrOn = menuItemsAudio.firstWhere((element) => element.id == 'lounge_SpeakerPwrOn') as GenericSelection;

    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MapAll') as GenericSelection;
    GenericSelection globalEntertainmentHDMILounge = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMILoungeAll') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMIGlobalAll') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMIAVODAll') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera1All') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera2All') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera3All') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera4All') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera5All') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera6All') as GenericSelection;

    BargraphModel globalVolume = menuItemsAudio.firstWhere((element) => element.id == 'lounge_volume') as BargraphModel;
    BargraphModel globalBass = menuItemsAudio.firstWhere((element) => element.id == 'lounge_bass') as BargraphModel;
    BargraphModel globalTreble = menuItemsAudio.firstWhere((element) => element.id == 'lounge_treble') as BargraphModel;
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'lounge_Camera6All') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['lounge_video_all'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'lounge_brightnessAll', // ⭐ ID z config
    ) as BargraphModel;
