...
class LightsStaffAreaUpwashPanel extends StatelessWidget {
  const LightsStaffAreaUpwashPanel({super.key});

  static const String _menuKey = 'lights_staff_upwash';
  static const String _prefix = 'staff_upwash';
