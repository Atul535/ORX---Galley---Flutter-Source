...
import 'lights_lounge_hallway_ceiling_panel.dart';
import 'lights_lounge_hallway_dnwash_panel.dart';
import 'lights_lounge_hallway_magazine_panel.dart';
import 'lights_lounge_hallway_toekick_panel.dart';
import 'lights_lounge_hallway_upwash_panel.dart';

class LightsLoungeHallwayAreaScreen extends StatefulWidget {
  final RoomType roomType;

  const LightsLoungeHallwayAreaScreen({super.key, required this.roomType});

  @override
  State<LightsLoungeHallwayAreaScreen> createState() => _LightsLoungeHallwayAreaScreenState();
}

class _LightsLoungeHallwayAreaScreenState extends State<LightsLoungeHallwayAreaScreen> {
  ...
  static const List<TabSpec> _groupTabs = [
    ...
    TabSpec(id: 'magazine', label: 'MAGAZINE', flex: 20, iconSize: 60, fontSize: 26),
  ];
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsLoungeHallwayCeilingPanel(),
      'upwash': (_) => const LightsLoungeHallwayUpwashPanel(),
      'dnwash': (_) => const LightsLoungeHallwayDnwashPanel(),
      'toekick': (_) => const LightsLoungeHallwayToekickPanel(),
      'magazine': (_) => const LightsLoungeHallwayMagazinePanel(),
    };
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_hallway_ceiling', 'hallway_ceiling_power'),
      'upwash': _findGenericSelection('lights_hallway_upwash', 'hallway_upwash_indication_power'),
      'dnwash': _findGenericSelection('lights_hallway_dnwash', 'hallway_dnwash_indication_power'),
      'toekick': _findGenericSelection('lights_hallway_toekick', 'hallway_toekick_indication_power'),
      'magazine': _findGenericSelection('lights_hallway_magazine', 'hallway_magazine_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_hallway_all'] as List<dynamic>;
    String menuPrefix = 'hallway_';
