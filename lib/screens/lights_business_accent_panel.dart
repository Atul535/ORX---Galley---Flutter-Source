...
class LightsBusinessAccentPanel extends StatelessWidget {
  const LightsBusinessAccentPanel({super.key});

  static const String _menuKey = 'lights_business_accent';
  static const String _prefix = 'business_accent';
