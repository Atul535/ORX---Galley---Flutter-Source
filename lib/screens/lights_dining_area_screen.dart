...
import 'lights_dining_ceiling_panel.dart';
import 'lights_dining_dnwash_panel.dart';
import 'lights_dining_dome_panel.dart';
import 'lights_dining_toekick_panel.dart';
import 'lights_dining_upwash_panel.dart';

class LightsDiningAreaScreen extends StatefulWidget {
  const LightsDiningAreaScreen({super.key});

  @override
  State<LightsDiningAreaScreen> createState() => _LightsDiningAreaScreenState();
}

class _LightsDiningAreaScreenState extends State<LightsDiningAreaScreen> {
  ...
  String _getImagePath(RoomType? roomType) {
    switch (roomType) {
      default:
        return 'assets/backgrounds/dining.png';
    }
  }
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsDiningCeilingPanel(),
      'dome': (_) => const LightsDiningDomePanel(),
      'upwash': (_) => const LightsDiningUpwashPanel(),
      'dnwash': (_) => const LightsDiningDnwashPanel(),
      'toekick': (_) => const LightsDiningToekickPanel(),
    };
  ...
  // =========================
  // LEFT: image + bulbs overlay (direction-lights-dining)
  // =========================
  Widget _buildDirLightsPanel(
    ...
    final lightsDirection = (configItems['dining-direction-lights'] ?? configItems['direction-lights-dining']) as List<dynamic>;
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_dining_ceiling', 'dining_ceiling_power'),
      'dome': _findGenericSelection('lights_dining_dome', 'dining_dome_indication_power'),
      'upwash': _findGenericSelection('lights_dining_upwash', 'dining_upwash_indication_power'),
      'dnwash': _findGenericSelection('lights_dining_dnwash', 'dining_dnwash_indication_power'),
      'toekick': _findGenericSelection('lights_dining_toekick', 'dining_toekick_indication_power'),
    };
  ...
  Widget _buildMultiRowTabBar(
    ...
    // while sharing the same tab-building approach as lights_dining_main_screen.dart.
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_dining_all'] as List<dynamic>;
    String menuPrefix = 'dining_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_dining_presets'] as List<dynamic>;
