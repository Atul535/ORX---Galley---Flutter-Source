...
class LightsLoungeLoungeUpwashPanel extends StatelessWidget {
  const LightsLoungeLoungeUpwashPanel({super.key});

  static const String _menuKey = 'lights_lounge_upwash';
  static const String _prefix = 'lounge_upwash';
