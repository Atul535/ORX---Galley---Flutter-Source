...
class ShadesLoungeAndHallwayRightPanel extends StatelessWidget {
  const ShadesLoungeAndHallwayRightPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GenericSelection shadesRHDown = menuItems?.firstWhere((element) => element.id == 'lounge_globalShadesRHDown') as GenericSelection;
    GenericSelection shadesRHUp = menuItems?.firstWhere((element) => element.id == 'lounge_globalShadesRHUp') as GenericSelection;
