...
class LightsLoungeHallwayToekickPanel extends StatelessWidget {
  const LightsLoungeHallwayToekickPanel({super.key});

  static const String _menuKey = 'lights_hallway_toekick';
  static const String _prefix = 'hallway_toekick';
