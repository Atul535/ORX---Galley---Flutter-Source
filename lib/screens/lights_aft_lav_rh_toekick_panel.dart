...
class LightsAftLavRhToekickPanel extends StatelessWidget {
  const LightsAftLavRhToekickPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_rh_toekick';
  static const String _prefix = 'aft_lav_rh_toekick';
