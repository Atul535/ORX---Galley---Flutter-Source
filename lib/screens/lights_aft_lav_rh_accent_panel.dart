...
class LightsAftLavRhAccentPanel extends StatelessWidget {
  const LightsAftLavRhAccentPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_rh_accent';
  static const String _prefix = 'aft_lav_rh_accent';
