...
class LightsVipLavCeilingPanel extends StatelessWidget {
  const LightsVipLavCeilingPanel({super.key});

  static const String _menuKey = 'lights_vip_lav_ceiling';
  static const String _prefix = 'vip_lav_ceiling_';
