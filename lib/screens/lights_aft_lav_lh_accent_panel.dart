...
class LightsAftLavLhAccentPanel extends StatelessWidget {
  const LightsAftLavLhAccentPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_lh_accent';
  static const String _prefix = 'aft_lav_lh_accent';
