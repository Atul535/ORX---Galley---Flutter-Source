...
class LightsLoungeAllUpwashPanel extends StatelessWidget {
  const LightsLoungeAllUpwashPanel({super.key});

  static const String _menuKey = 'lounge_and_hallway_lights_all_upwash';
  static const String _prefix = 'lounge_and_hallway_all_upwash';
