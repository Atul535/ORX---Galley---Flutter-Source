...
class LightsBedroomToekickPanel extends StatelessWidget {
  const LightsBedroomToekickPanel({super.key});

  static const String _menuKey = 'lights_bedroom_toekick';
  static const String _prefix = 'bedroom_toekick';
