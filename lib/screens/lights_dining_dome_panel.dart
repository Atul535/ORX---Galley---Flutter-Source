...
class LightsDiningDomePanel extends StatelessWidget {
  const LightsDiningDomePanel({super.key});

  static const String _menuKey = 'lights_dining_dome';
  static const String _prefix = 'dining_dome';
