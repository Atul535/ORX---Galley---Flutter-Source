...
class AttendantStaffPanel extends StatelessWidget {
  const AttendantStaffPanel({super.key});

  static const String _menuKey = 'lights_lounge_lounge_upwash';
  static const String _prefix = 'lounge_lounge_up';
  ...
  Widget build(BuildContext context) {
    ...
    final BargraphModel washBrt = menuItems.firstWhere((e) => e.id == '${_prefix}wash_brt') as BargraphModel;
    final BargraphModel washTemp = menuItems.firstWhere((e) => e.id == '${_prefix}wash_temp') as BargraphModel;
    final GenericSelection washPwr = menuItems.firstWhere((e) => e.id == '${_prefix}wash_power') as GenericSelection;
    final GenericSelection colorPicker =
        menuItems.firstWhere((e) => e.id == '${_prefix}wash_colorPicker') as GenericSelection;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('ATTENDANT', style: myTheme.textTheme?.bodySmall),
          ...
          Row(
            ...
            children: [
              ...
              //             .setCurrentState(colorPicker.id.toString(), 0, silently: true);
              //
              //         return ColorPicker(
              //           id: colorPicker.id,
              ...
              //             Provider.of<CurrentStateProvider>(context, listen: false)
              //                 .setCurrentState(colorPicker.id, 0, data: colorData);
              //           },
              //         );
              //       },
              //     ),
