...
class LightsLoungeHallwayMagazinePanel extends StatelessWidget {
  const LightsLoungeHallwayMagazinePanel({super.key});

  static const String _menuKey = 'lights_hallway_magazine';
  static const String _prefix = 'hallway_magazine';
