...
class LightsAftLavRhDnwashPanel extends StatelessWidget {
  const LightsAftLavRhDnwashPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_rh_dnwash';
  static const String _prefix = 'aft_lav_rh_dnwash';
