...
class LightsStaffAreaCeilingPanel extends StatelessWidget {
  const LightsStaffAreaCeilingPanel({super.key});

  static const String _menuKey = 'lights_staff_ceiling';
  static const String _prefix = 'staff_ceiling_';
