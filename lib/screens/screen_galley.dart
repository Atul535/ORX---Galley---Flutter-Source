...
import 'lights_galley.dart';

class GalleyScreen extends StatefulWidget {
  static const routeName = '/app/galley';
...
class _GalleyScreenState extends State<GalleyScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
      ...
      wallpaper: 'assets/backgrounds/bg_entry_lights.png',
      widget: const LightsGalleyScreen(),
    ),
  ];
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_galley';
    String lopaImage = 'assets/YG039-LOPA_Final_galley.png';
    String menuTitle = 'FWD ENTRY / GALLEY';
