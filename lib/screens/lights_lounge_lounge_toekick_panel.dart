...
class LightsLoungeLoungeToekickPanel extends StatelessWidget {
  const LightsLoungeLoungeToekickPanel({super.key});

  static const String _menuKey = 'lights_lounge_toekick';
  static const String _prefix = 'lounge_toekick';
