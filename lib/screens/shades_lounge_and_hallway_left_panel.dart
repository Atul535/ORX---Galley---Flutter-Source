...
class ShadesLoungeAndHallwayLeftPanel extends StatelessWidget {
  const ShadesLoungeAndHallwayLeftPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GenericSelection shadesLHDown = menuItems?.firstWhere((element) => element.id == 'lounge_globalShadesLHDown') as GenericSelection;
    GenericSelection shadesLHUp = menuItems?.firstWhere((element) => element.id == 'lounge_globalShadesLHUp') as GenericSelection;
