...
class LightsDiningUpwashPanel extends StatelessWidget {
  const LightsDiningUpwashPanel({super.key});

  static const String _menuKey = 'lights_dining_upwash';
  static const String _prefix = 'dining_upwash';
