...
import 'lights_aft_lav_lh_accent_panel.dart';
import 'lights_aft_lav_lh_ceiling_panel.dart';
import 'lights_aft_lav_lh_dnwash_panel.dart';
import 'lights_aft_lav_lh_toekick_panel.dart';

class LightsAftLavLhAreaScreen extends StatefulWidget {
  const LightsAftLavLhAreaScreen({super.key});

  @override
  State<LightsAftLavLhAreaScreen> createState() => _LightsAftLavLhAreaScreenState();
}

class _LightsAftLavLhAreaScreenState extends State<LightsAftLavLhAreaScreen> {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsAftLavLhCeilingPanel(),
      'dnwash': (_) => const LightsAftLavLhDnwashPanel(),
      'toekick': (_) => const LightsAftLavLhToekickPanel(),
      'accent': (_) => const LightsAftLavLhAccentPanel(),
    };
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_aft_lav_lh_ceiling', 'aft_lav_lh_ceiling_power'),
      'dnwash': _findGenericSelection('lights_aft_lav_lh_dnwash', 'aft_lav_lh_dnwash_indication_power'),
      'toekick': _findGenericSelection('lights_aft_lav_lh_toekick', 'aft_lav_lh_toekick_indication_power'),
      'accent': _findGenericSelection('lights_aft_lav_lh_accent', 'aft_lav_lh_accent_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_aft_lav_lh_all'] as List<dynamic>;
    String menuPrefix = 'aft_lav_lh_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_aft_lav_lh_presets'] as List<dynamic>;
