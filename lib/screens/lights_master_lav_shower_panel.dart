...
class LightsMasterLavShowerPanel extends StatelessWidget {
  const LightsMasterLavShowerPanel({super.key});

  static const String _menuKey = 'lights_master_lav_shower';
  static const String _prefix = 'master_lav_shower';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('SHOWER', style: myTheme.textTheme?.bodySmall),
