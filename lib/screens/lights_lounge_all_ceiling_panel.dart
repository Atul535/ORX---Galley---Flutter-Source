...
class LightsLoungeAllCeilingPanel extends StatelessWidget {
  const LightsLoungeAllCeilingPanel({super.key});

  static const String _menuKey = 'lounge_and_hallway_all_ceiling_lights';
  static const String _prefix = 'lounge_and_hallway_ceilingAll_';
