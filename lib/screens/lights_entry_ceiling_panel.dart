...
class LightsEntryCeilingPanel extends StatelessWidget {
  const LightsEntryCeilingPanel({super.key});

  static const String _menuKey = 'lights_entry_ceiling';
  static const String _prefix = 'entry_ceiling_';
