...
class LightsBedroomBedPanel extends StatelessWidget {
  const LightsBedroomBedPanel({super.key});

  static const String _menuKey = 'lights_bedroom_bed';
  static const String _prefix = 'bedroom_bed';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('BED', style: myTheme.textTheme?.bodySmall),
