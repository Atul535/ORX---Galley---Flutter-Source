...
class LightsVipLavUpwashPanel extends StatelessWidget {
  const LightsVipLavUpwashPanel({super.key});

  static const String _menuKey = 'lights_vip_lav_upwash';
  static const String _prefix = 'vip_lav_upwash';
