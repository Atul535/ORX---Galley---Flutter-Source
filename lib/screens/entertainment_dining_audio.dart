...
class EntertainmentDiningAudio extends StatefulWidget {
  const EntertainmentDiningAudio({super.key, title});

  @override
  State<EntertainmentDiningAudio> createState() => _EntertainmentDiningAudioState();
}

class _EntertainmentDiningAudioState extends State<EntertainmentDiningAudio> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  String title = '';
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['dining_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentSpeakerPwr = menuItems.firstWhere((element) => element.id == 'dining_SpeakerPwr') as GenericSelection;

    GenericSelection globalEntertainmentHDMILounge = menuItems.firstWhere((element) => element.id == 'dining_HDMILoungeAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItems.firstWhere((element) => element.id == 'dining_HDMIGlobalAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItems.firstWhere((element) => element.id == 'dining_HDMIAVODAudio') as GenericSelection;

    BargraphModel globalVolume = menuItems.firstWhere((element) => element.id == 'dining_volume') as BargraphModel;
    BargraphModel globalBass = menuItems.firstWhere((element) => element.id == 'dining_bass') as BargraphModel;
    BargraphModel globalTreble = menuItems.firstWhere((element) => element.id == 'dining_treble') as BargraphModel;
