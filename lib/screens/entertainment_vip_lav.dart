...
class EntertainmentVipLavScreen extends StatefulWidget {
  const EntertainmentVipLavScreen({super.key, title});

  @override
  State<EntertainmentVipLavScreen> createState() => _EntertainmentVipLavScreenState();
}

class _EntertainmentVipLavScreenState extends State<EntertainmentVipLavScreen> with TickerProviderStateMixin {
  String title = '';
