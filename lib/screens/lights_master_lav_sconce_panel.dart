...
class LightsMasterLavSconcePanel extends StatelessWidget {
  const LightsMasterLavSconcePanel({super.key});

  static const String _menuKey = 'lights_master_lav_sconce';
  static const String _prefix = 'master_lav_sconce';
