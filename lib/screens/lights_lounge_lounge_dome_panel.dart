...
class LightsLoungeLoungeDomePanel extends StatelessWidget {
  const LightsLoungeLoungeDomePanel({super.key});

  static const String _menuKey = 'lights_lounge_dome';
  static const String _prefix = 'lounge_dome';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('DOME', style: myTheme.textTheme?.bodySmall),
