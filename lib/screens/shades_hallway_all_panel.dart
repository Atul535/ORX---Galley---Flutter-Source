...
class ShadesHallwayAllPanel extends StatelessWidget {
  const ShadesHallwayAllPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GenericSelection shadesAllDown = menuItems?.firstWhere((element) => element.id == 'hallwayShadesLHDown') as GenericSelection;
    GenericSelection shadesAllUp = menuItems?.firstWhere((element) => element.id == 'hallwayShadesLHUp') as GenericSelection;
