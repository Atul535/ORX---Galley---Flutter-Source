...
import 'lights_galley_aft.dart';

class AftGalleyScreen extends StatefulWidget {
  static const routeName = '/app/aftGalley';
  const AftGalleyScreen({super.key});

  @override
  State<AftGalleyScreen> createState() => _AftGalleyScreenState();
}

class _AftGalleyScreenState extends State<AftGalleyScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
      ...
      wallpaper: 'assets/backgrounds/bg_aftgalley_lights2.png',
      icon: Icons.lightbulb,
      widget: const LightGalleyAftScreen(),
    ),
  ];
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_aftGalley';
    String lopaImage = 'assets/YG039-LOPA_Final_AftGalley.png';
    String menuTitle = 'AFT GALLEY';
