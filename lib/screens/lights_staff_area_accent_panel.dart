...
class LightsStaffAreaAccentPanel extends StatelessWidget {
  const LightsStaffAreaAccentPanel({super.key});

  static const String _menuKey = 'lights_staff_accent';
  static const String _prefix = 'staff_accent';
