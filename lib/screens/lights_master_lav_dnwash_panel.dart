...
class LightsMasterLavDnwashPanel extends StatelessWidget {
  const LightsMasterLavDnwashPanel({super.key});

  static const String _menuKey = 'lights_master_lav_dnwash';
  static const String _prefix = 'master_lav_dnwash';
