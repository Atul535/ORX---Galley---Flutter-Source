...
class ShadesDiningLeftPanel extends StatelessWidget {
  const ShadesDiningLeftPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GenericSelection shadesLHDown = menuItems?.firstWhere((element) => element.id == 'dining_globalShadesLHDown') as GenericSelection;
    GenericSelection shadesLHUp = menuItems?.firstWhere((element) => element.id == 'dining_globalShadesLHUp') as GenericSelection;
