...
import '../model/dir_light_layout_rel.dart';
...
import 'lights_aft_lav_lh_ceiling_panel.dart';
import 'lights_aft_lav_lh_toekick_panel.dart';

import 'lights_master_lav_accent_panel.dart';
import 'lights_master_lav_ceiling_panel.dart';
import 'lights_master_lav_dnwash_panel.dart';
import 'lights_master_lav_sconce_panel.dart';
import 'lights_master_lav_shower_panel.dart';
import 'lights_master_lav_toekick_panel.dart';
import 'lights_master_lav_upwash_panel.dart';
import 'lights_vip_lav_accent_panel.dart';
import 'lights_vip_lav_sconce_panel.dart';
import 'lights_vip_lav_upwash_panel.dart';

class LightsMasterLavAreaScreen extends StatefulWidget {
  const LightsMasterLavAreaScreen({super.key});

  @override
  State<LightsMasterLavAreaScreen> createState() => _LightsMasterLavAreaScreenState();
}

class _LightsMasterLavAreaScreenState extends State<LightsMasterLavAreaScreen> {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsMasterLavCeilingPanel(),
      'upwash': (_) => const LightsMasterLavUpwashPanel(),
      'dnwash': (_) => const LightsMasterLavDnwashPanel(),
      'toekick': (_) => const LightsMasterLavToekickPanel(),
      'accent': (_) => const LightsMasterLavAccentPanel(),
      'sconce': (_) => const LightsMasterLavSconcePanel(),
      'shower': (_) => const LightsMasterLavShowerPanel(),
    };
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_master_lav_ceiling', 'master_lav_ceiling_power'),
      'upwash': _findGenericSelection('lights_master_lav_upwash', 'master_lav_upwash_indication_power'),
      'dnwash': _findGenericSelection('lights_master_lav_dnwash', 'master_lav_dnwash_indication_power'),
      'toekick': _findGenericSelection('lights_master_lav_toekick', 'master_lav_toekick_indication_power'),
      'accent': _findGenericSelection('lights_master_lav_accent', 'master_lav_accent_indication_power'),
      'sconce': _findGenericSelection('lights_master_lav_sconce', 'master_lav_sconce_indication_power'),
      'shower': _findGenericSelection('lights_master_lav_shower', 'master_lav_shower_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
     final menuItems = configItems['lights_master_lav_all'] as List<dynamic>;
    String menuPrefix = 'master_lav_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_master_lav_presets'] as List<dynamic>;
