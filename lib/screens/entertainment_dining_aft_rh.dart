...
class EntertainmentDiningAftRh extends StatefulWidget {
  const EntertainmentDiningAftRh({super.key, title});

  @override
  State<EntertainmentDiningAftRh> createState() => _EntertainmentDiningAftRhState();
}

class _EntertainmentDiningAftRhState extends State<EntertainmentDiningAftRh> with TickerProviderStateMixin {
  String title = '';
  ...
  double getMenuWidth() {
    switch (selectedSource) {
      case 'dining_Camera6AftRh':
        return 0.4; // 30% pro kamery (málo tlačítek)
      case 'dining_MapAftRh':
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'dining_Camera5AftRh',
      'dining_Camera6AftRh',
      'dining_HDMILoungeAftRh',
      'dining_HDMIGlobalAftRh',
      'dining_HDMIAVODAftRh',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'dining_MapAftRh') {
      return 'MAP CONTROLS';
    }
  ...
  @override
  void didUpdateWidget(EntertainmentDiningAftRh oldWidget) {
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['dining_video_aft_rh'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['dining_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwr = menuItemsVideo.firstWhere((element) => element.id == 'dining_MonitorPwrAftRh') as GenericSelection;
    ...
    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'dining_MapAftRh') as GenericSelection;
    GenericSelection globalEntertainmentHDMILounge = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMILoungeAftRh') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMIGlobalAftRh') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMIAVODAftRh') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera1AftRh') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera2AftRh') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera3AftRh') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera4AftRh') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera5AftRh') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera6AftRh') as GenericSelection;
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'dining_Camera6AftRh') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['dining_video_aft_rh'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'dining_brightnessAftRh', // ⭐ ID z config
    ) as BargraphModel;
