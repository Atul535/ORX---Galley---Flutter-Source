import 'package:ORX_Galley/screens/lights_lounge_all_accent_panel.dart';
import 'package:ORX_Galley/screens/lights_lounge_all_magazine_panel.dart';
...
import 'lights_lounge_all_ceiling_panel.dart';
import 'lights_lounge_all_dnwash_panel.dart';
import 'lights_lounge_all_dome_panel.dart';
import 'lights_lounge_all_toekick_panel.dart';
import 'lights_lounge_all_upwash_panel.dart';

class LightsLoungeAllAreaScreen extends StatefulWidget {
  final RoomType roomType;

  const LightsLoungeAllAreaScreen({super.key, required this.roomType});

  @override
  State<LightsLoungeAllAreaScreen> createState() => _LightsLoungeAllAreaScreenState();
}

class _LightsLoungeAllAreaScreenState extends State<LightsLoungeAllAreaScreen> {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsLoungeAllCeilingPanel(),
      'dome': (_) => const LightsLoungeAllDomePanel(),
      'upwash': (_) => const LightsLoungeAllUpwashPanel(),
      'dnwash': (_) => const LightsLoungeAllDnwashPanel(),
      'toekick': (_) => const LightsLoungeAllToekickPanel(),
      'accent': (_) => const LightsLoungeAllAccentPanel(),
      'magazine': (_) => const LightsLoungeAllMagazinePanel(),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_lounge_and_hallway_all'] as List<dynamic>;
    String menuPrefix = 'lounge_and_hallway_';
