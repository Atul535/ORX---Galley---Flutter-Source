...
import 'lights_vip_lav_ceiling_panel.dart';
import 'lights_vip_lav_sconce_panel.dart';
import 'lights_vip_lav_toekick_panel.dart';
import 'lights_vip_lav_upwash_panel.dart';

class LightsVipLavAreaScreen extends StatefulWidget {
  const LightsVipLavAreaScreen({super.key});

  @override
  State<LightsVipLavAreaScreen> createState() => _LightsVipLavAreaScreenState();
}

class _LightsVipLavAreaScreenState extends State<LightsVipLavAreaScreen> {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsVipLavCeilingPanel(),
      'upwash': (_) => const LightsVipLavUpwashPanel(),
      'toekick': (_) => const LightsVipLavToekickPanel(),
      'accent': (_) => const LightsVipLavAccentPanel(),
      'sconce': (_) => const LightsVipLavSconcePanel(),
    };
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_vip_lav_ceiling', 'vip_lav_ceiling_power'),
      'upwash': _findGenericSelection('lights_vip_lav_upwash', 'vip_lav_upwash_indication_power'),
      'toekick': _findGenericSelection('lights_vip_lav_toekick', 'vip_lav_toekick_indication_power'),
      'accent': _findGenericSelection('lights_vip_lav_accent', 'vip_lav_accent_indication_power'),
      'sconce': _findGenericSelection('lights_vip_lav_sconce', 'vip_lav_sconce_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_vip_lav_all'] as List<dynamic>;
    String menuPrefix = 'vip_lav_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_vip_lav_presets'] as List<dynamic>;
