...
import 'entertainment_dining.dart';
import 'lights_dining.dart';
import 'shades_dining_main_screen.dart';
import '../widgets/pullup_tab.dart';

class DiningScreen extends StatefulWidget {
  static const routeName = '/app/dining';
...
class _DiningScreenState extends State<DiningScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
        ...
        wallpaper: 'assets/backgrounds/bg_dining_lights.png',
        widget: const LightsDiningScreen()),
    SideMenuItem(
        title: 'ENTERTAINMENT',
        id: 'mi_entertainment',
        icon: Icons.personal_video,
        backgroundImage: 'assets/banners/banner_entertainment.png',
        wallpaper: 'assets/backgrounds/bg_dining_ent.png',
        widget: const EntertainmentDiningScreen()),
    SideMenuItem(
      title: 'SHADES',
      id: 'mi_shades',
      ...
      widget: const ShadesDiningScreen(),
    ),
    // SideMenuItem(
    //   title: 'TEMPERATURE',
    //   id: 'mi_temperature',
    ...
    //   wallpaper: 'assets/backgrounds/bg_dining_temp.png',
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_dining';
    String lopaImage = 'assets/YG039-LOPA_Final_dining.png';
    String menuTitle = 'DINING / CONFERENCE';
