...
class LightsBedroomCeilingPanel extends StatelessWidget {
  const LightsBedroomCeilingPanel({super.key});

  static const String _menuKey = 'lights_bedroom_ceiling';
  static const String _prefix = 'bedroom_ceiling_';
