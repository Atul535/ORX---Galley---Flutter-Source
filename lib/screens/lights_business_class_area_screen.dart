...
import 'lights_business_accent_panel.dart';
import 'lights_business_dnwash_panel.dart';
import 'lights_business_upwash_panel.dart';

class LightsBusinessClassAreaScreen extends StatefulWidget {
  const LightsBusinessClassAreaScreen({super.key});

  @override
  State<LightsBusinessClassAreaScreen> createState() => _LightsBusinessClassAreaScreenState();
}

class _LightsBusinessClassAreaScreenState extends State<LightsBusinessClassAreaScreen> {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'upwash': (_) => const LightsBusinessUpwashPanel(),
      'dnwash': (_) => const LightsBusinessDnwashPanel(),
      'accent': (_) => const LightsBusinessAccentPanel(),
    };
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'upwash': _findGenericSelection('lights_business_upwash', 'business_upwash_indication_power'),
      'dnwash': _findGenericSelection('lights_business_dnwash', 'business_dnwash_indication_power'),
      'accent': _findGenericSelection('lights_business_accent', 'business_accent_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_business_all'] as List<dynamic>;
    String menuPrefix = 'business_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_business_presets'] as List<dynamic>;
