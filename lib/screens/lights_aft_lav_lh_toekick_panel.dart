...
class LightsAftLavLhToekickPanel extends StatelessWidget {
  const LightsAftLavLhToekickPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_lh_toekick';
  static const String _prefix = 'aft_lav_lh_toekick';
