...
class EntertainmentBedroomFwd extends StatefulWidget {
  const EntertainmentBedroomFwd({super.key, title});

  @override
  State<EntertainmentBedroomFwd> createState() => _EntertainmentBedroomFwdState();
}

class _EntertainmentBedroomFwdState extends State<EntertainmentBedroomFwd> with TickerProviderStateMixin {
  String title = '';
  ...
  bool get hasControls {
    ...
    // return selectedSource == 'bedroomEntertainmentMap' || selectedSource!.contains('Camera6');
  }
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'bedroom_Camera5Fwd',
      'bedroom_Camera6Fwd',
      'bedroom_HDMILoungeFwd',
      'bedroom_HDMIGlobalFwd',
      'bedroom_HDMIAVODFwd',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'bedroom_MapFwd') {
      return 'MAP CONTROLS';
    }
  ...
  @override
  void didUpdateWidget(EntertainmentBedroomFwd oldWidget) {
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['bedroom_video'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['bedroom_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwr = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_MonitorPwrFwd') as GenericSelection;
    GenericSelection globalEntertainmentSpeakerPwr = menuItemsAudio.firstWhere((element) => element.id == 'bedroom_SpeakerPwr') as GenericSelection;

    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_MapFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIbedroom = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_HDMILoungeFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_HDMIGlobalFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_HDMIAVODFwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_Camera1Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_Camera2Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_Camera3Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_Camera4Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_Camera5Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'bedroom_Camera6Fwd') as GenericSelection;

    BargraphModel globalVolume = menuItemsAudio.firstWhere((element) => element.id == 'bedroom_volume') as BargraphModel;
    BargraphModel globalBass = menuItemsAudio.firstWhere((element) => element.id == 'bedroom_bass') as BargraphModel;
    BargraphModel globalTreble = menuItemsAudio.firstWhere((element) => element.id == 'bedroom_treble') as BargraphModel;
                    ...
                    Wrap(
                      ...
                      children: [
                        ...[
                          ...
                          globalEntertainmentHDMIbedroom,
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'bedroom_Camera6Fwd') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['bedroom_video'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'bedroom_brightnessFwd', // ⭐ ID z config
    ) as BargraphModel;
