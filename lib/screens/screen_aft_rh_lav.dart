...
import 'lights_aft_lav_rh_main_screen.dart';

class AftLavScreen extends StatefulWidget {
  static const routeName = '/app/aftLav';
  const AftLavScreen({super.key});

  @override
  State<AftLavScreen> createState() => _AftLavScreenState();
}

class _AftLavScreenState extends State<AftLavScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
      ...
      widget: const LightsAftLavRhMainScreen(),
    ),
  ];
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_aftLav';
    String lopaImage = 'assets/YG039-LOPA_Final_AftLav.png';
    String menuTitle = 'AFT RH LAV';
