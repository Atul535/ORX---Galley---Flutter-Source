...
class LightsDiningDnwashPanel extends StatelessWidget {
  const LightsDiningDnwashPanel({super.key});

  static const String _menuKey = 'lights_dining_dnwash';
  static const String _prefix = 'dining_dnwash';
