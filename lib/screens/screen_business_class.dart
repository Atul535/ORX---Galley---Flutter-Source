...
import 'entertainment_business_class.dart';
import 'lights_business_class.dart';
import 'divider_office.dart';
import 'temp_screen.dart';
import '../widgets/pullup_tab.dart';

class BusinessClassScreen extends StatefulWidget {
  static const routeName = '/app/office';
  const BusinessClassScreen({super.key});

  @override
  State<BusinessClassScreen> createState() => _BusinessClassScreenState();
}

class _BusinessClassScreenState extends State<BusinessClassScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
      ...
      wallpaper: 'assets/backgrounds/bg_bizclass_lights.png',
      widget: const LightsBusinessClassScreen(),
    ),
    SideMenuItem(
      title: 'ENTERTAINMENT',
      id: 'mi_entertainment',
      ...
      wallpaper: 'assets/backgrounds/bg_bizclass_ent.png',
      widget: const EntertainmentBusinessClassScreen(),
    ),
    // SideMenuItem(
    //   title: 'DIVIDER',
    //   id: 'mi_entertainment',
    //   icon: Icons.roller_shades,
    //   widget: const ShadesOfficeScreen(),
    // ),
    // SideMenuItem(
    //   title: 'TEMPERATURE',
    //   id: 'mi_entertainment',
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_office';
    String lopaImage = 'assets/YG039-LOPA_Final_office.png';
    String menuTitle = 'BUSINESS CLASS';
