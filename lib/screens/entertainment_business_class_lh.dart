...
class EntertainmentBusinessClassLh extends StatefulWidget {
  const EntertainmentBusinessClassLh({super.key, title});

  @override
  State<EntertainmentBusinessClassLh> createState() => _EntertainmentBusinessClassLhState();
}

class _EntertainmentBusinessClassLhState extends State<EntertainmentBusinessClassLh> with TickerProviderStateMixin {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    final menuItems = configItems['business_video_lh'] as List<dynamic>;
    final BargraphModel monitorBrightness = menuItems.firstWhere((e) => e.id == 'business_brightnessLh') as BargraphModel;
  ...
  Widget _buildMapControls(CustomTheme myTheme) {
    ...
    final GenericSelection monitorPwr = configItems['business_video_lh']?.firstWhere((e) => e.id == 'business_MonitorPwrLh') as GenericSelection;
