...
class LightsLoungeHallwayCeilingPanel extends StatelessWidget {
  const LightsLoungeHallwayCeilingPanel({super.key});

  static const String _menuKey = 'lights_hallway_ceiling';
  static const String _prefix = 'hallway_ceiling_';
