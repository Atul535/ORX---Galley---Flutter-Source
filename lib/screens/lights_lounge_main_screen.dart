...
class LightsLoungeScreen extends StatefulWidget {
  const LightsLoungeScreen({super.key, title});

  @override
  State<LightsLoungeScreen> createState() => _LightsLoungeScreenState();
}

class _LightsLoungeScreenState extends State<LightsLoungeScreen> with TickerProviderStateMixin {
  String title = '';
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: const TabBarView(
              ...
              children: <Widget>[
                LightsLoungeAllAreaScreen(roomType: RoomType.loungeAndHallway),
                LightsLoungeLoungeAreaScreen(roomType: RoomType.lounge),
                LightsLoungeHallwayAreaScreen(roomType: RoomType.hallway),
              ],
            ),
          ),
        ),
