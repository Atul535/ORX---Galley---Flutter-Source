...
class ShadesLoungeAllPanel extends StatelessWidget {
  const ShadesLoungeAllPanel({super.key});
  ...
  Widget build(BuildContext context) {
   ...
   List<dynamic> menuItems = configItems['lounge_shades'] as List<dynamic>;
    ...
    GenericSelection shadesAllDown = menuItems?.firstWhere((element) => element.id == 'loungeShadesAllDown') as GenericSelection;
    GenericSelection shadesAllUp = menuItems?.firstWhere((element) => element.id == 'loungeShadesAllUp') as GenericSelection;
