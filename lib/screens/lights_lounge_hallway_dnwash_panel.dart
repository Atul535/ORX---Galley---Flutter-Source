...
class LightsLoungeHallwayDnwashPanel extends StatelessWidget {
  const LightsLoungeHallwayDnwashPanel({super.key});

  static const String _menuKey = 'lights_hallway_dnwash';
  static const String _prefix = 'hallway_dnwash';
