...
class LightsAftLavLhCeilingPanel extends StatelessWidget {
  const LightsAftLavLhCeilingPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_lh_ceiling';
  static const String _prefix = 'aft_lav_lh_ceiling_';
