...
class LightsBusinessUpwashPanel extends StatelessWidget {
  const LightsBusinessUpwashPanel({super.key});

  static const String _menuKey = 'lights_business_upwash';
  static const String _prefix = 'business_upwash';
