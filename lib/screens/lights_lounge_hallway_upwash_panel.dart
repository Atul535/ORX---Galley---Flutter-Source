...
class LightsLoungeHallwayUpwashPanel extends StatelessWidget {
  const LightsLoungeHallwayUpwashPanel({super.key});

  static const String _menuKey = 'lights_hallway_upwash';
  static const String _prefix = 'hallway_upwash';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('UPWASH', style: myTheme.textTheme?.bodySmall),
                  ...
                  children: [
                    ...
                    Selector<CurrentStateProvider, List<int>>(
                      selector: (context, provider) =>
                          provider.getCurrentStateObject(colorPicker.id.toString()).data,
