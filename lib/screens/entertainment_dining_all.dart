...
class EntertainmentDiningAll extends StatefulWidget {
  const EntertainmentDiningAll({super.key, title});

  @override
  State<EntertainmentDiningAll> createState() => _EntertainmentDiningAllState();
}

class _EntertainmentDiningAllState extends State<EntertainmentDiningAll> with TickerProviderStateMixin {
  String title = '';
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'dining_Camera5All',
      'dining_Camera6All',
      'dining_HDMILoungeAll',
      'dining_HDMIGlobalAll',
      'dining_HDMIAVODAll',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'dining_MapAll') {
      return 'MAP CONTROLS';
    }
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['dining_video_all'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['dining_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwrOff = menuItemsVideo.firstWhere((element) => element.id == 'dining_MonitorPwrOffAll') as GenericSelection;
    GenericSelection globalEntertainmentMonitorPwrOn = menuItemsVideo.firstWhere((element) => element.id == 'dining_MonitorPwrOnAll') as GenericSelection;
    GenericSelection globalEntertainmentSpeakerPwrOff = menuItemsAudio.firstWhere((element) => element.id == 'dining_SpeakerPwrOff') as GenericSelection;
    GenericSelection globalEntertainmentSpeakerPwrOn = menuItemsAudio.firstWhere((element) => element.id == 'dining_SpeakerPwrOn') as GenericSelection;

    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'dining_MapAll') as GenericSelection;
    GenericSelection globalEntertainmentHDMILounge = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMILoungeAll') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMIGlobalAll') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMIAVODAll') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera1All') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera2All') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera3All') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera4All') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera5All') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera6All') as GenericSelection;
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'dining_Camera6All') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['dining_video_all'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'dining_brightnessAll', // ⭐ ID z config
    ) as BargraphModel;
