...
class EntertainmentMasterLavAudio extends StatefulWidget {
  const EntertainmentMasterLavAudio({super.key, title});

  @override
  State<EntertainmentMasterLavAudio> createState() => _EntertainmentMasterLavAudioState();
}

class _EntertainmentMasterLavAudioState extends State<EntertainmentMasterLavAudio> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  String title = '';
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['master_lav_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentSpeakerPwr = menuItems.firstWhere((element) => element.id == 'master_lav_SpeakerPwr') as GenericSelection;

    GenericSelection globalEntertainmentHDMILounge = menuItems.firstWhere((element) => element.id == 'master_lav_HDMILoungeAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItems.firstWhere((element) => element.id == 'master_lav_HDMIGlobalAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItems.firstWhere((element) => element.id == 'master_lav_HDMIAVODAudio') as GenericSelection;

    BargraphModel globalVolume = menuItems.firstWhere((element) => element.id == 'master_lav_volume') as BargraphModel;
    BargraphModel globalBass = menuItems.firstWhere((element) => element.id == 'master_lav_bass') as BargraphModel;
    BargraphModel globalTreble = menuItems.firstWhere((element) => element.id == 'master_lav_treble') as BargraphModel;
