...
class LightsBedroomDnwashPanel extends StatelessWidget {
  const LightsBedroomDnwashPanel({super.key});

  static const String _menuKey = 'lights_bedroom_dnwash';
  static const String _prefix = 'bedroom_dnwash';
