...
class LightsStaffAreaAttendantPanel extends StatelessWidget {
  const LightsStaffAreaAttendantPanel({super.key});

  static const String _menuKey = 'lights_staff_attendant';
  static const String _prefix = 'staff_attendant';
