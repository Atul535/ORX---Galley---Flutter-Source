...
class LightsVipLavToekickPanel extends StatelessWidget {
  const LightsVipLavToekickPanel({super.key});

  static const String _menuKey = 'lights_vip_lav_toekick';
  static const String _prefix = 'vip_lav_toekick';
