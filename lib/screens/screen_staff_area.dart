...
import 'lights_staff_area.dart';

class StaffAreaScreen extends StatefulWidget {
  static const routeName = '/app/staffArea';
  const StaffAreaScreen({super.key});

  @override
  State<StaffAreaScreen> createState() => _StaffAreaScreenState();
}

class _StaffAreaScreenState extends State<StaffAreaScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
      ...
      wallpaper: 'assets/backgrounds/bg_staff_lights.png',
      icon: Icons.lightbulb,
      widget: const LightsStaffAreaScreen(),
    ),
  ];
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_StaffArea';
    String lopaImage = 'assets/YG039-LOPA_Final_Staff.png';
    String menuTitle = 'STAFF AREA';
