...
import 'lights_entry_ceiling_panel.dart';
import 'lights_entry_toekick_panel.dart';

class LightsEntryAreaScreen extends StatefulWidget {
  const LightsEntryAreaScreen({super.key});

  @override
  State<LightsEntryAreaScreen> createState() => _LightsEntryAreaScreenState();
}

class _LightsEntryAreaScreenState extends State<LightsEntryAreaScreen> {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsEntryCeilingPanel(),
      'toekick': (_) => const LightsEntryToekickPanel(),
    };
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_entry_ceiling', 'entry_ceiling_power'),
      'toekick': _findGenericSelection('lights_entry_toekick', 'entry_toekick_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_entry_all'] as List<dynamic>;
    String menuPrefix = 'entry_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_entry_presets'] as List<dynamic>;
