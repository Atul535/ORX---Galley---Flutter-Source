...
class LightsBusinessClassMainScreen extends StatefulWidget {
  const LightsBusinessClassMainScreen({super.key, title});

  @override
  State<LightsBusinessClassMainScreen> createState() => _LightsBusinessClassMainScreenState();
}

class _LightsBusinessClassMainScreenState extends State<LightsBusinessClassMainScreen> with TickerProviderStateMixin {
  String title = '';
      ...
      child: Padding(
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: const LightsBusinessClassAreaScreen(),
          ),
        ),
      ),
    );
