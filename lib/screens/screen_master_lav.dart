...
import 'entertainment_master_lav.dart';
import 'lights_master_lav_main_screen.dart';
import 'shades_master_lav_main_screen.dart';
import 'temp_screen.dart';

class MasterLavScreen extends StatefulWidget {
  static const routeName = '/app/masterLav';
  const MasterLavScreen({super.key});

  @override
  State<MasterLavScreen> createState() => _MasterLavScreenState();
}

class _MasterLavScreenState extends State<MasterLavScreen> {
  ...
  List<SideMenuItem> menuItems = [
    SideMenuItem(
      ...
      wallpaper: 'assets/backgrounds/bg_mastelav_lights.png',
      widget: const LightsMasterLavMainScreen(),
    ),
    SideMenuItem(
      title: 'ENTERTAINMENT',
      id: 'mi_entertainment',
      ...
      wallpaper: 'assets/backgrounds/bg_mastelav_lights.png',
      widget: const EntertainmentMasterLavScreen(),
    ),
    SideMenuItem(
      title: 'SHADES',
      id: 'mi_shades',
      ...
      wallpaper: 'assets/backgrounds/bg_mastelav_shades.png',
      widget: const ShadesMasterLavScreen(),
    ),
    SideMenuItem(
      title: 'TEMPERATURE',
      id: 'mi_temperature',
  ...
  Widget build(BuildContext context) {
    String navigationKey = 'navBarCurrState_masterLav';
    String lopaImage = 'assets/YG039-LOPA_Final_VIPLav.png';
    String menuTitle = 'MASTER LAV';
