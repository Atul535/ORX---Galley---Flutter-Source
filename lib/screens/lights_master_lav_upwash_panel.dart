...
class LightsMasterLavUpwashPanel extends StatelessWidget {
  const LightsMasterLavUpwashPanel({super.key});

  static const String _menuKey = 'lights_master_lav_upwash';
  static const String _prefix = 'master_lav_upwash';
