...
class EntertainmentLoungeAft extends StatefulWidget {
  const EntertainmentLoungeAft({super.key, title});

  @override
  State<EntertainmentLoungeAft> createState() => _EntertainmentLoungeAftState();
}

class _EntertainmentLoungeAftState extends State<EntertainmentLoungeAft> with TickerProviderStateMixin {
  String title = '';
  ...
  bool get hasControls {
    ...
    // return selectedSource == 'loungeEntertainmentMap' || selectedSource!.contains('Camera6');
  }
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'lounge_Camera5Aft',
      'lounge_Camera6Aft',
      'lounge_HDMILoungeAft',
      'lounge_HDMIGlobalAft',
      'lounge_HDMIAVODAft',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'lounge_MapAft') {
      return 'MAP CONTROLS';
    }
  ...
  @override
  void didUpdateWidget(EntertainmentLoungeAft oldWidget) {
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['lounge_video_aft'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['lounge_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwr = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MonitorPwrAft') as GenericSelection;
    GenericSelection globalEntertainmentSpeakerPwr = menuItemsAudio.firstWhere((element) => element.id == 'lounge_SpeakerPwr') as GenericSelection;

    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'lounge_MapAft') as GenericSelection;
    GenericSelection globalEntertainmentHDMILounge = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMILoungeAft') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMIGlobalAft') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'lounge_HDMIAVODAft') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera1Aft') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera2Aft') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera3Aft') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera4Aft') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera5Aft') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'lounge_Camera6Aft') as GenericSelection;
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'lounge_Camera6Aft') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['lounge_video_aft'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'lounge_brightnessAft', // ⭐ ID z config
    ) as BargraphModel;
