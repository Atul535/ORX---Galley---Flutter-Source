...
class LightsBedroomUpwashPanel extends StatelessWidget {
  const LightsBedroomUpwashPanel({super.key});

  static const String _menuKey = 'lights_bedroom_upwash';
  static const String _prefix = 'bedroom_upwash';
