...
class ShadesLoungeRightPanel extends StatelessWidget {
  const ShadesLoungeRightPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GenericSelection shadesRHDown = menuItems?.firstWhere((element) => element.id == 'loungeShadesRHDown') as GenericSelection;
    GenericSelection shadesRHUp = menuItems?.firstWhere((element) => element.id == 'loungeShadesRHUp') as GenericSelection;
