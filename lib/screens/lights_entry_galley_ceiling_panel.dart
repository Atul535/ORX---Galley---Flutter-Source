...
class LightsEntryGalleyCeilingPanel extends StatelessWidget {
  const LightsEntryGalleyCeilingPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('GALLEY CEILING', style: myTheme.textTheme?.bodySmall),
