...
class EntertainmentLoungeAudio extends StatefulWidget {
  const EntertainmentLoungeAudio({super.key, title});

  @override
  State<EntertainmentLoungeAudio> createState() => _EntertainmentLoungeAudioState();
}

class _EntertainmentLoungeAudioState extends State<EntertainmentLoungeAudio> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  String title = '';
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['lounge_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentSpeakerPwr = menuItems.firstWhere((element) => element.id == 'lounge_SpeakerPwr') as GenericSelection;

    GenericSelection globalEntertainmentHDMILounge = menuItems.firstWhere((element) => element.id == 'lounge_HDMILoungeAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItems.firstWhere((element) => element.id == 'lounge_HDMIGlobalAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItems.firstWhere((element) => element.id == 'lounge_HDMIAVODAudio') as GenericSelection;

    BargraphModel globalVolume = menuItems.firstWhere((element) => element.id == 'lounge_volume') as BargraphModel;
    BargraphModel globalBass = menuItems.firstWhere((element) => element.id == 'lounge_bass') as BargraphModel;
    BargraphModel globalTreble = menuItems.firstWhere((element) => element.id == 'lounge_treble') as BargraphModel;
