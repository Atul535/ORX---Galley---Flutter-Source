...
class LightsDiningCeilingPanel extends StatelessWidget {
  const LightsDiningCeilingPanel({super.key});

  static const String _menuKey = 'lights_dining_ceiling';
  static const String _prefix = 'dining_ceiling_';
