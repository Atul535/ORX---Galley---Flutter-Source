...
class LightsLoungeLoungeDnwashPanel extends StatelessWidget {
  const LightsLoungeLoungeDnwashPanel({super.key});

  static const String _menuKey = 'lights_lounge_dnwash';
  static const String _prefix = 'lounge_dnwash';
