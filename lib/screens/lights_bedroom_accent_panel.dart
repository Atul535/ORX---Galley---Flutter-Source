...
class LightsBedroomAccentPanel extends StatefulWidget {
  const LightsBedroomAccentPanel({super.key});

  static const String _menuKey = 'lights_bedroom_accent';
  static const String _prefix = 'bedroom_accent';

  @override
  State<LightsBedroomAccentPanel> createState() => _LightsBedroomAccentPanelState();
}

class _LightsBedroomAccentPanelState extends State<LightsBedroomAccentPanel> {
  ...
  void initState() {
    ...
    menuItems = configItems[LightsBedroomAccentPanel._menuKey] ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    final washPwr = _findItem<GenericSelection>('${LightsBedroomAccentPanel._prefix}_power');
