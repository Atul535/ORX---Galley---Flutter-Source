...
class EntertainmentDiningFwd extends StatefulWidget {
  const EntertainmentDiningFwd({super.key, title});

  @override
  State<EntertainmentDiningFwd> createState() => _EntertainmentDiningFwdState();
}

class _EntertainmentDiningFwdState extends State<EntertainmentDiningFwd> with TickerProviderStateMixin {
  String title = '';
  ...
  void _checkActiveSource() {
    ...
    final sources = [
      ...
      'dining_Camera5Fwd',
      'dining_Camera6Fwd',
      'dining_HDMILoungeFwd',
      'dining_HDMIGlobalFwd',
      'dining_HDMIAVODFwd',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'dining_MapFwd') {
      return 'MAP CONTROLS';
    }
  ...
  @override
  void didUpdateWidget(EntertainmentDiningFwd oldWidget) {
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItemsVideo = configItems['dining_video_fwd'] as List<dynamic>;
    List<dynamic> menuItemsAudio = configItems['dining_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentMonitorPwr = menuItemsVideo.firstWhere((element) => element.id == 'dining_MonitorPwrFwd') as GenericSelection;
    ...
    GenericSelection globalEntertainmentMap = menuItemsVideo.firstWhere((element) => element.id == 'dining_MapFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMILounge = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMILoungeFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMIGlobalFwd') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItemsVideo.firstWhere((element) => element.id == 'dining_HDMIAVODFwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera1 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera1Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera2 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera2Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera3 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera3Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera4 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera4Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera5 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera5Fwd') as GenericSelection;
    GenericSelection globalEntertainmentCamera6 = menuItemsVideo.firstWhere((element) => element.id == 'dining_Camera6Fwd') as GenericSelection;
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'dining_Camera6Fwd') {
  ...
  Widget _buildMonitorBrightnessControl(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['dining_video_fwd'] as List<dynamic>;
    BargraphModel monitorBrightness = menuItems.firstWhere(
      (element) => element.id == 'dining_brightnessFwd', // ⭐ ID z config
    ) as BargraphModel;
