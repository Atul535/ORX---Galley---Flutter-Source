...
import 'entertainment_master_lav_audio.dart';
import 'lights_lounge_lounge_area_screen.dart';

class EntertainmentMasterLavScreen extends StatefulWidget {
  const EntertainmentMasterLavScreen({super.key, title});

  @override
  State<EntertainmentMasterLavScreen> createState() => _EntertainmentMasterLavScreenState();
}

class _EntertainmentMasterLavScreenState extends State<EntertainmentMasterLavScreen> with TickerProviderStateMixin {
  String title = '';
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: const TabBarView(
              ...
              children: <Widget>[
                EntertainmentMasterLavAudio(key: PageStorageKey('masterLavAudio')),
