...
class LightsAftLavRhCeilingPanel extends StatelessWidget {
  const LightsAftLavRhCeilingPanel({super.key});

  static const String _menuKey = 'lights_aft_lav_rh_ceiling';
  static const String _prefix = 'aft_lav_rh_ceiling_';
