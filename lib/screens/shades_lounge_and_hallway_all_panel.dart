...
class ShadesLoungeAndHallwayAllPanel extends StatelessWidget {
  const ShadesLoungeAndHallwayAllPanel({super.key});
  ...
  Widget build(BuildContext context) {
   ...
   List<dynamic> menuItems = configItems['lounge_shades'] as List<dynamic>;
    ...
    GenericSelection shadesAllDown = menuItems?.firstWhere((element) => element.id == 'lounge_globalShadesAllDown') as GenericSelection;
    GenericSelection shadesAllUp = menuItems?.firstWhere((element) => element.id == 'lounge_globalShadesAllUp') as GenericSelection;
