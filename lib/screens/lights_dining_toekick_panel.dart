...
class LightsDiningToekickPanel extends StatelessWidget {
  const LightsDiningToekickPanel({super.key});

  static const String _menuKey = 'lights_dining_toekick';
  static const String _prefix = 'dining_toekick';
