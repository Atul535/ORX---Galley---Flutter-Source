...
class LightsMasterLavAccentPanel extends StatelessWidget {
  const LightsMasterLavAccentPanel({super.key});

  static const String _menuKey = 'lights_master_lav_accent';
  static const String _prefix = 'master_lav_accent';
