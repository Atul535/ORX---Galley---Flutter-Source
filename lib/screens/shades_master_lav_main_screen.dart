...
import 'shades_master_lav_area_screen.dart';

class ShadesMasterLavScreen extends StatefulWidget {
  const ShadesMasterLavScreen({super.key, title});

  @override
  State<ShadesMasterLavScreen> createState() => _ShadesMasterLavScreenState();
}

class _ShadesMasterLavScreenState extends State<ShadesMasterLavScreen> with TickerProviderStateMixin {
  String title = '';
    ...
    return ActivityDetector(
      child: Padding(
        ...
        child: Scaffold(
          ...
          body: const ShadesMasterLavAreaScreen(),
        ),
      ),
    );
  }
