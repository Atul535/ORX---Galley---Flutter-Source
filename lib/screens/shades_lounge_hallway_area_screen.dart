...
import 'shades_hallway_all_panel.dart';

class ShadesLoungeHallwayAreaScreen extends StatefulWidget {
  const ShadesLoungeHallwayAreaScreen({super.key});

  @override
  State<ShadesLoungeHallwayAreaScreen> createState() => _ShadesLoungeHallwayAreaScreenState();
}

class _ShadesLoungeHallwayAreaScreenState extends State<ShadesLoungeHallwayAreaScreen> {
  ...
  static const List<TabSpec> _groupTabs = [
    ...
    //   label: 'LEFT',
    //   flex: 20,
    //   iconAsset: 'assets/icons/icon_shade_closed.png',
    //   iconSize: 60,
  ...
  String _getImagePath(RoomType roomType) {
    switch (roomType) {
      case RoomType.lounge:
        return 'assets/backgrounds/hallway.png';
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'all': (_) => const ShadesHallwayAllPanel(),
    };
