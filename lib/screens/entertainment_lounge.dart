...
import 'entertainment_lounge_aft.dart';
...
class EntertainmentLoungeScreen extends StatefulWidget {
  const EntertainmentLoungeScreen({super.key, title});

  @override
  State<EntertainmentLoungeScreen> createState() => _EntertainmentLoungeScreenState();
}

class _EntertainmentLoungeScreenState extends State<EntertainmentLoungeScreen> with TickerProviderStateMixin {
  String title = '';
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: const TabBarView(
              ...
              children: <Widget>[
                EntertainmentLoungeFwd(key: PageStorageKey('fwd')),
                EntertainmentLoungeAft(key: PageStorageKey('aft')),
                EntertainmentLoungeAll(key: PageStorageKey('all')),
                EntertainmentLoungeAudio(key: PageStorageKey('audio')),
