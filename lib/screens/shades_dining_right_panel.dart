...
class ShadesDiningRightPanel extends StatelessWidget {
  const ShadesDiningRightPanel({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GenericSelection shadesRHDown = menuItems?.firstWhere((element) => element.id == 'dining_globalShadesRHDown') as GenericSelection;
    GenericSelection shadesRHUp = menuItems?.firstWhere((element) => element.id == 'dining_globalShadesRHUp') as GenericSelection;
