...
import 'lights_bedroom_accent_panel.dart';
import 'lights_bedroom_bed_panel.dart';
import 'lights_bedroom_ceiling_panel.dart';
import 'lights_bedroom_dnwash_panel.dart';
import 'lights_bedroom_toekick_panel.dart';
import 'lights_bedroom_upwash_panel.dart';

class LightsBedroomAreaScreen extends StatefulWidget {
  const LightsBedroomAreaScreen({super.key, title});

  @override
  State<LightsBedroomAreaScreen> createState() => _LightsBedroomAreaScreenState();
}

class _LightsBedroomAreaScreenState extends State<LightsBedroomAreaScreen> with TickerProviderStateMixin {
  ...
  Widget _buildRightPanel(CustomTheme myTheme) {
    final Map<String, WidgetBuilder> panels = {
      'ceiling': (_) => const LightsBedroomCeilingPanel(),
      'upwash': (_) => const LightsBedroomUpwashPanel(),
      'dnwash': (_) => const LightsBedroomDnwashPanel(),
      'toekick': (_) => const LightsBedroomToekickPanel(),
      'bed': (_) => const LightsBedroomBedPanel(),
      'accent': (_) => const LightsBedroomAccentPanel(),
    };
  ...
  Widget _buildDirLightsPanel(
    ...
    final lightsDirection = (configItems['bedroom-direction-lights'] ?? configItems['direction-lights-bedroom']) as List<dynamic>;
  ...
  Map<String, GenericSelection> _buildTabPowerItems() {
    final candidates = <String, GenericSelection?>{
      'ceiling': _findGenericSelection('lights_bedroom_ceiling', 'bedroom_ceiling_power'),
      'upwash': _findGenericSelection('lights_bedroom_upwash', 'bedroom_upwash_indication_power'),
      'dnwash': _findGenericSelection('lights_bedroom_dnwash', 'bedroom_dnwash_indication_power'),
      'toekick': _findGenericSelection('lights_bedroom_toekick', 'bedroom_toekick_indication_power'),
      'bed': _findGenericSelection('lights_bedroom_bed', 'bedroom_bed_indication_power'),
      'accent': _findGenericSelection('lights_bedroom_accent', 'bedroom_accent_indication_power'),
    };
  ...
  Widget _buildGlobalControls(CustomTheme myTheme) {
    final menuItems = configItems['lights_bedroom_all'] as List<dynamic>;
    String menuPrefix = 'bedroom_';
  ...
  Widget _buildSideMenuContent(CustomTheme myTheme) {
    final menuItems = configItems['lights_bedroom_presets'] as List<dynamic>;
