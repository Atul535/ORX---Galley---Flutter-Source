...
class LightsVipLavMainScreen extends StatefulWidget {
  const LightsVipLavMainScreen({super.key, title});

  @override
  State<LightsVipLavMainScreen> createState() => _LightsVipLavMainScreenState();
}

class _LightsVipLavMainScreenState extends State<LightsVipLavMainScreen> with TickerProviderStateMixin {
  String title = '';
      ...
      child: Padding(
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: const LightsVipLavAreaScreen(),
          ),
        ),
      ),
    );
