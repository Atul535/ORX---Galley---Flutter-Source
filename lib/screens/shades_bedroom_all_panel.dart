...
class ShadesBedroomAllPanel extends StatelessWidget {
  const ShadesBedroomAllPanel({super.key});
  ...
  Widget build(BuildContext context) {
   ...
   List<dynamic> menuItems = configItems['bedroom_shades'] as List<dynamic>;

    GenericSelection shadesAllDown = menuItems?.firstWhere((element) => element.id == 'bedroom_globalShadesRHDown') as GenericSelection;
    GenericSelection shadesAllUp = menuItems?.firstWhere((element) => element.id == 'bedroom_globalShadesRHUp') as GenericSelection;
