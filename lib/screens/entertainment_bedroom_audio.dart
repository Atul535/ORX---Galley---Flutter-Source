...
class EntertainmentBedroomAudio extends StatefulWidget {
  const EntertainmentBedroomAudio({super.key, title});

  @override
  State<EntertainmentBedroomAudio> createState() => _EntertainmentBedroomAudioState();
}

class _EntertainmentBedroomAudioState extends State<EntertainmentBedroomAudio> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  String title = '';
  final Map<String, bool> _cardPressedStates = {};

  bool isControlsMenuOpen = false;
  ...
  double getMenuWidth() {
    switch (selectedSource) {
      case 'loungeEntertainmentCamera6':
        return 0.3; // 30% pro kamery (málo tlačítek)
      case 'loungeEntertainmentMap':
  ...
  void _checkActiveSource() {
    ...
    // Seznam všech zdrojů
    final sources = [
      'loungeEntertainmentMap',
      'loungeEntertainmentCamera1',
      'loungeEntertainmentCamera2',
      'loungeEntertainmentCamera3',
      'loungeEntertainmentCamera4',
      'loungeEntertainmentCamera5',
      'loungeEntertainmentCamera6',
      'loungeEntertainmentHDMIBedroom',
      'loungeEntertainmentHDMIGlobal',
      'loungeEntertainmentHDMIAVOD',
    ];
  ...
  String getTabText() {
    ...
    if (selectedSource == 'bedroomEntertainmentMap') {
      return 'MAP CONTROLS';
    }
  ...
  Widget _buildGroupControls(CustomTheme myTheme) {
    List<dynamic> menuItems = configItems['bedroom_audio'] as List<dynamic>;

    GenericSelection globalEntertainmentSpeakerPwr = menuItems.firstWhere((element) => element.id == 'bedroom_SpeakerPwr') as GenericSelection;

    GenericSelection globalEntertainmentHDMILounge = menuItems.firstWhere((element) => element.id == 'bedroom_HDMILoungeAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIGlobal = menuItems.firstWhere((element) => element.id == 'bedroom_HDMIGlobalAudio') as GenericSelection;
    GenericSelection globalEntertainmentHDMIAVOD = menuItems.firstWhere((element) => element.id == 'bedroom_HDMIAVODAudio') as GenericSelection;

    BargraphModel globalVolume = menuItems.firstWhere((element) => element.id == 'bedroom_volume') as BargraphModel;
    BargraphModel globalBass = menuItems.firstWhere((element) => element.id == 'bedroom_bass') as BargraphModel;
    BargraphModel globalTreble = menuItems.firstWhere((element) => element.id == 'bedroom_treble') as BargraphModel;
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...[globalEntertainmentSpeakerPwr].map(
                          (item) => Padding(
                    ...
                    Wrap(
                      ...
                      runSpacing: 10.0,
                      children: [
                        ...[globalEntertainmentHDMILounge, globalEntertainmentHDMIGlobal, globalEntertainmentHDMIAVOD].map(
                          (item) => Padding(
  ...
  Widget _buildDynamicContent(CustomTheme myTheme) {
    // Camera 6 ovládání
    if (selectedSource == 'loungeEntertainmentCamera6') {
      return _buildCameraControls(myTheme);
    }

    // MAP ovládání
    if (selectedSource == 'loungeEntertainmentMap') {
