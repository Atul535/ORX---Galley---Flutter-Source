...
class LightsStaffAreaDnwashPanel extends StatelessWidget {
  const LightsStaffAreaDnwashPanel({super.key});

  static const String _menuKey = 'lights_staff_dnwash';
  static const String _prefix = 'staff_dnwash';
