...
class ColorPickerInput extends StatefulWidget {
  const ColorPickerInput(this.color, this.onColorChanged,
      {Key? key,
      this.enableAlpha = true,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        if (!widget.embeddedText) const SizedBox(width: 10),
        SizedBox(
          ...
          child: Transform.scale(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                isDense: true,
                label: widget.embeddedText ? Text('Hex') : null,
                contentPadding:
